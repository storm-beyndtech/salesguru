...
export default function Balance({ type, user }: BalanceProps) {
  ...
  return (
    <div className="p-2 bg-gray-100 dark:bg-gray-800 rounded-3xl">
      <div className='bg-white rounded-3xl'>
        <div className="min-w-80 bg-cover bg-center p-5 flex justify-between" style={{ backgroundImage: `url(${balBg})` }}>
          <div>
            <p className="text-gray-400 font-semibold font-krub text-sm">
              Balance
            </p>
            <h1 className="text-5xl font-krub font-medium text-black my-4">
